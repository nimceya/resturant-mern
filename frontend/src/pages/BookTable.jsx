...
const BookTable = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      // HALKAN BAA WAX LAGA BEDDELAY: Waxaan raacinay Headers leh Authorization Token
      const { data } = await axios.post("/api/booking/create", formData, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`, // Ama halkii aad ku kaydisay token-kaaga
        },
      });
